              ...
              <div className="container">
                <div className="row text-center">
                  <div className="col-md-4 mb-3">
                    <div className="package-card card border-secondary h-100">
                  ...
                  <div className="col-md-4 mb-3">
                    <div className="package-card card border-warning h-100">
                      <div className="card-body">
                  ...
                  <div className="col-md-4 mb-3">
                    <div className="package-card card border-primary h-100">
                      <div className="card-body">
